...
osm_data = import_street_data ( [ "toulouse.osm" ] )
...
tisseo_data = import_gtfs_data( '20130705-tisseo-gtfs.zip', 'Tisseo' )
...
#------------------------------------------------------------------------------------------------------------
cost1 = transferEdge( duration = 30, mode_change = True )
